"""
Django settings for ufsm_projetos project.
...
SECRET_KEY = 'r$1z^qlt-9-vtp81stqy%bo^$6#)2nh+6cd9&&=9!$x-i1dyen'
...
ROOT_URLCONF = 'ufsm_projetos.urls'

WSGI_APPLICATION = 'ufsm_projetos.wsgi.application'
